...
const ExploreMenu = ({category,setCategory}) => {
    ...
    return (
        <div className="menu_problem" id='menu_problem'>
            ...
            <p className="explore-menu-text">Select your skin problem type to unlock the perfect treatment for you</p>
            <div className="explore-menu_problem">
                {menu_problem.map((item, index) => (
                    <div onClick={()=>setCategory(prev=>prev===item.menu_name?"All":item.menu_name)}key={index} className="explore-menu_problem-item">
