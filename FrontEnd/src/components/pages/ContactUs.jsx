      ...
      >
        <div className="about-overlay">
          ...
          <p className="about-description">
            SkinWhisper is an innovative skincare website that assists users in
            finding personalized skincare routines and suitable products based
            on their skin type and concerns. We are dedicated to providing
            high-quality, effective solutions tailored to meet the unique needs
            of each individual.
          </p>
        </div>
      </header>
      ...
      <section className="team-section">
        ...
        <div className="team-cards">
          ...
          <div className="team-card">
            ...
            <a
              href="https://www.linkedin.com/in/renad-alghamdi-621767249?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
              target="_blank"
              rel="noopener noreferrer"
              className="team-link"
            >
